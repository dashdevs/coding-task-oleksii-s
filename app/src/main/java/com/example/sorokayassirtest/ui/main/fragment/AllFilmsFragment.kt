...
import com.example.sorokayassirtest.databinding.FragmentAllFilmsBinding
import com.example.sorokayassirtest.domain.entity.Film
import com.example.sorokayassirtest.ui.main.MainViewModel
import com.example.sorokayassirtest.ui.main.adapter.FilmAdapter
import com.example.sorokayassirtest.ui.main.adapter.ItemClickListener
import com.example.sorokayassirtest.ui.main.adapter.fingerprints.FilmFingerprint
import com.example.sorokayassirtest.ui.main.adapter.fingerprints.NetworkingFingerprint
import com.example.sorokayassirtest.ui.main.adapter.fingerprints.PressTryAgain
import com.squareup.moshi.JsonAdapter
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class AllFilmsFragment : Fragment(), PressTryAgain, ItemClickListener {
    private var _binding: FragmentAllFilmsBinding? = null
    private val binding get() = _binding!!
    private val viewModel: MainViewModel by activityViewModels()
    private val filmAdapter = FilmAdapter(getFingerprints(), this)
    ...
    override fun omItemClick(film: Film) {
        val jsonAdapter: JsonAdapter<Film> = moshi.adapter(Film::class.java)
        val action = AllFilmsFragmentDirections.actionFilmsAllFragmentToFilmFragment(jsonAdapter.toJson(film))
